...
class MeuTrabalhoScreen extends StatelessWidget {
  const MeuTrabalhoScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const GradientAppBar(title: 'Meu Trabalho (Sincronizado)'),
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text(
                        'Atividade de ${ocorrencia.tipo_atividade ?? ''} em ${DateFormat('dd/MM/yyyy').format(ocorrencia.data_atividade!)}'),
                    onTap: () {
                      // No future, this could navigate to a read-only detail view.
                    },
                  ),
                );
              },
